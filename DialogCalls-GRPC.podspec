Pod::Spec.new do |spec|
  ...
  spec.source = { :git => "https://github.com/dialogs/server-api-calls-sdk.git" }
  ...
  spec.prepare_command = <<-CMD
    ...
    #{protoc} #{src}/*.proto \
        ...
        --swift_out=FileNaming=DropPath,Visibility=Public:#{exportDir} \
        --swiftgrpc_out=Client=true,Server=false,TestStubs=true,FileNaming=DropPath,Visibility=Public:#{exportDir} \
        -I #{protoc_dir} \
        -I #{src} \
  ...
  msgSpec.source_files = "#{exportDir}/**/*.pb.swift"
  msgSpec.header_mappings_dir = exportDir
  msgSpec.requires_arc = true
  end

  # Files generated by the gRPC plugin
  spec.subspec "Services" do |srvSpec|
  srvSpec.source_files = "#{exportDir}/**/*.grpc.swift"
  srvSpec.header_mappings_dir = exportDir
