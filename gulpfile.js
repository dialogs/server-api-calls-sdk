...
gulp.task ('grpc-replace-enum', ['grpc-generate'], function () {
    return gulp
        ...
        .pipe(gulpReplace('ICE_SETTINGS_RELAY = 1', 'ICE_SETTINGS_RELAY = "ICE_SETTINGS_RELAY"'))
        .pipe(gulpReplace('ICE_SETTINGS_ALL = 2', 'ICE_SETTINGS_ALL = "ICE_SETTINGS_ALL"'))
        .pipe(gulpReplace('ICE_SETTINGS_NONE = 3', 'ICE_SETTINGS_NONE = "ICE_SETTINGS_NONE"'))
