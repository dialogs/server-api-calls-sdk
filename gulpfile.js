...
const grpcReplace = () => gulp
        ...
        .pipe(gulpReplace('DISPOSE_REASON_CALLEE_NOT_FOUND = 5', 'DISPOSE_REASON_CALLEE_NOT_FOUND = "DISPOSE_REASON_CALLEE_NOT_FOUND"'))
        ...
        .pipe(gulpReplace('DISPOSE_REASON_CALLER_DISABLED = 9', 'DISPOSE_REASON_CALLER_DISABLED = "DISPOSE_REASON_CALLER_DISABLED"'))
        .pipe(gulpReplace('DISPOSE_REASON_CALLEE_DISABLED = 10', 'DISPOSE_REASON_CALLEE_DISABLED = "DISPOSE_REASON_CALLEE_DISABLED"'))
